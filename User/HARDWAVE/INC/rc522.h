...
#define PCD_AUTHENT										0x0E  	// Authentication Key                       //验证密钥
...
#define PICC_REQIDL										0x26   	// find the antenna area does not enter hibernation //寻天线区内未进入休眠状态
#define PICC_REQALL										0x52   	// find all the cards antenna area                  //寻天线区内全部卡
#define PICC_ANTICOLL									0x93   	// anti-collision                                   //防冲撞
#define PICC_SElECTTAG									0x93   	// election card                                    //选举卡
#define PICC_AUTHENT1A									0x60   	// authentication key A                             //验证A密钥
#define PICC_AUTHENT1B									0x61   	// authentication key B                             //验证B密钥
